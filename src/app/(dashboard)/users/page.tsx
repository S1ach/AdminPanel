...
function UsersContent() {
  ...
  const handleExport = () => {
    ...
    const headers = ['id', 'name', 'email', 'role', 'status', 'registeredAt'];
    const csvContent = [
      headers.join(','),
      ...data.data.map((u) =>
        [
    ...
    link.href = url;
    link.setAttribute('download', `users_export_page_${page}.csv`);
  ...
  const roleOptions = [
    ...
    ...USER_ROLES.map((r) => ({ label: t.common[r], value: r })),
  ];
  const statusOptions = [
    { label: t.users.allStatuses, value: '' },
    ...USER_STATUSES.map((s) => ({ label: t.common[s], value: s })),
  ];
              ...
              {data.data.map((u) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-zinc-400 text-xs">
                    {formatDate(u.registeredAt, locale === 'ru' ? 'ru-RU' : 'en-US')}
                  </td>
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="flex gap-3">
            <div className="flex-1 flex flex-col gap-1.5">
              ...
              <Select
                options={USER_ROLES.map((r) => ({ label: t.common[r], value: r }))}
                value={editForm.role}
            ...
            <div className="flex-1 flex flex-col gap-1.5">
              ...
              <Select
                options={USER_STATUSES.map((s) => ({ label: t.common[s], value: s }))}
