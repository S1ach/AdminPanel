...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-600 flex items-center justify-center flex-shrink-0 shadow-md shadow-indigo-500/10">
          <svg className="w-5 h-5 text-white fill-current" viewBox="0 0 786.66 910.83">
        ...
        {!collapsed && (
          <span className="font-extrabold text-zinc-900 dark:text-zinc-100 text-base tracking-wide uppercase bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-600 bg-clip-text text-transparent">
            Admin Panel
          </span>
        )}
      </div>
